            ...
            <div className="max-w-4xl mx-auto relative z-10">
                ...
                >
                    ...
                    <div className="flex items-center gap-4 py-3 px-4 bg-white/5 border-t border-x border-white/10 rounded-t-sm text-gray-400">
                        <button type="button" className="hover:text-white transition-colors"><Bold size={16} /></button>
                        <button type="button" className="hover:text-white transition-colors"><Italic size={16} /></button>
                        <button type="button" className="hover:text-white transition-colors"><Underline size={16} /></button>
                        <div className="w-px h-4 bg-white/10 mx-2" />
                        <button type="button" className="hover:text-white transition-colors"><AlignLeft size={16} /></button>
                        <button type="button" className="hover:text-white transition-colors"><AlignCenter size={16} /></button>
                        <button type="button" className="hover:text-white transition-colors"><AlignRight size={16} /></button>
                        <div className="w-px h-4 bg-white/10 mx-2" />
                        <button
                            type="button"
